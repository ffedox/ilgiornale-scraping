...
3. Se ha 80 commenti, tirare giù l'articolo e i metadati + commenti più metadati -> [test_selenium6.py](https://github.com/ffedox/corpus_ilgiornale/blob/main/test_selenium6.py) per commenti e metadati, [extract_article_ilgiornale.py](https://github.com/ffedox/corpus_ilgiornale/blob/main/extract_article_ilgiornale.py) per articolo e metadati
